    ...
    <div class="row">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="footer-contact">
                        <h2>Salon Address</h2>
                        <p><i class="fa fa-map-marker-alt"></i>Infront of Ashish Hospital, Chandrika Apartment, Home Science College Rd, Napier Town, Jabalpur, Madhya Pradesh 482004</p>
        ...
        <div class="col-lg-5">
            <div class="footer-newsletter">
                <h2>Newsletter</h2>
                <p>
                    We are providing services to male and female like hair patches, hair extensions, hair topper, hair bigs for cancer patients, silicon bonding, hair cutting, facial, Cline up, grooming (Male & Female)
                </p>
                <div class="form">
